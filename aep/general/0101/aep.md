...
AEP-compliant APIs **must** document their HTTP APIs using the [OpenAPI
Specification (OAS)][], version 3.
...
If your API is built using the [Keap Micronaut BOM], the OAS version and YAML
file generation is automatically handled by the BOM.
