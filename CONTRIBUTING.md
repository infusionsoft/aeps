...
3. Create a directory for the aep, and update the aep.yaml file to "approved".
   [Full example PR](https://github.com/aep-dev/aep.dev/pull/77/files).
4. Modify the content from the aip markdown and paste over the aep.md content.
   ...
   - Extend any proto-specific guidance to include both OpenAPI and proto.
     representations.
5. Create a GitHub PR. A reviewer should be with you in 24 hours.
...
6. Come say hi in our various communication channels documented in the
